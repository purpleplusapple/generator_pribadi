...
class _GradientButtonState extends State<GradientButton>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      begin: 1.0,
      end: ClinicMotion.buttonPressScale,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: isDisabled
                ? LinearGradient(
                    colors: [
                      ClinicColors.laceGray.withValues(alpha: 0.3),
                      ClinicColors.laceGray.withValues(alpha: 0.3),
                    ],
                  )
                : ClinicGradients.primaryCta,
            borderRadius: ClinicRadius.buttonRadius,
            border: Border.all(
              color: isDisabled
                  ? Colors.transparent
                  : ClinicColors.metallicGold.withValues(alpha: 0.3),
              width: 1.5,
            ),
            boxShadow: isDisabled
                ...
                : [
                    // Primary shadow
                    BoxShadow(
                      color: ClinicColors.leatherTan.withValues(alpha: 0.4),
                      blurRadius: 20,
                      offset: const Offset(0, 6),
                    ),
                    // Secondary glow
                    BoxShadow(
                      color: ClinicColors.metallicGold.withValues(alpha: 0.25),
                      blurRadius: 12,
                ...
                : Row(
                    ...
                    children: [
                      if (widget.icon != null) ...[
                        ...
                        const SizedBox(width: ClinicSpacing.md), // Increased spacing
                      ],
                      Text(
                        widget.label,
