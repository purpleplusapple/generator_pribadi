          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', ClinicColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', ClinicColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: ClinicShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: ClinicColors.canvasWhite,
                                width: 3,
                              ),
                ...
                child: Center(
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                      ...
                      vertical: ClinicSpacing.md,
                    ),
                    decoration: BoxDecoration(
                      color: ClinicColors.soleBlack.withValues(alpha: 0.8),
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(
                        color: ClinicColors.canvasWhite.withValues(alpha: 0.2),
                      ),
                    ),
                    child: Row(
