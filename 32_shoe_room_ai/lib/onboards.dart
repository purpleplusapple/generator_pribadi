...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_Question> _questions = [
    ...
    _Question(
      keyName: 'q_flow',
      title: 'How do you plan to use Shoe Room AI?',
  ...
  Widget build(BuildContext context) {
    ...
    const primary = ShoeAIColors.leatherTan;
    const secondary = ShoeAIColors.metallicGold;
    const accentSoft = ShoeAIColors.laceGray;
    const bg = ShoeAIColors.soleBlack;
  ...
  String _finalStepText() {
    const steps = [
      ...
      'Securing your Shoe Room AI workspace…',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "What should we call you inside Shoe Room AI?",
                textAlign: TextAlign.center,
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? ShoeAIColors.leatherTan : Colors.white70;
