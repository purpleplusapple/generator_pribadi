...
class _GradientButtonState extends State<GradientButton>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      begin: 1.0,
      end: ShoeAIMotion.buttonPressScale,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: isDisabled
                ? LinearGradient(
                    colors: [
                      ShoeAIColors.laceGray.withValues(alpha: 0.3),
                      ShoeAIColors.laceGray.withValues(alpha: 0.3),
                    ],
                  )
            ...
            border: Border.all(
              color: isDisabled
                  ? Colors.transparent
                  : ShoeAIColors.metallicGold.withValues(alpha: 0.3),
              width: 1.5,
            ),
            boxShadow: isDisabled
                ...
                : [
                    // Primary shadow
                    BoxShadow(
                      color: ShoeAIColors.leatherTan.withValues(alpha: 0.4),
                      blurRadius: 20,
                      offset: const Offset(0, 6),
                    ),
                    // Secondary glow
                    BoxShadow(
                      color: ShoeAIColors.metallicGold.withValues(alpha: 0.25),
                      blurRadius: 12,
                ...
                : Row(
                    ...
                    children: [
                      if (widget.icon != null) ...[
                        ...
                        const SizedBox(width: ShoeAISpacing.md), // Increased spacing
                      ],
                      Text(
                        widget.label,
                        style: ShoeAIText.button.copyWith(
                          color: ShoeAIColors.soleBlack,
