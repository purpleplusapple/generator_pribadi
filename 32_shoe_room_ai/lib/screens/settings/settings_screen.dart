...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          Row(
            children: [
              Icon(
                ...
                color: _isPremium ? ShoeAIColors.laceGray : ShoeAIColors.leatherTan,
                size: 28,
              ),
  ...
  Widget _buildActionRow({
    ...
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: ShoeAISpacing.sm),
        child: Row(
          children: [
            Icon(
              icon,
              color: iconColor ?? ShoeAIColors.leatherTan,
              size: 24,
            ),
            const SizedBox(width: ShoeAISpacing.md),
            Expanded(
          ...
          Row(
            children: [
              Icon(
                ...
                color: _developerMode ? ShoeAIColors.laceGray : ShoeAIColors.canvasWhite.withValues(alpha: 0.7),
                size: 24,
              ),
              const SizedBox(width: ShoeAISpacing.md),
              Expanded(
              ...
              Switch(
                ...
                activeTrackColor: ShoeAIColors.leatherTan,
              ),
            ],
          ),
          ...
          if (_developerMode) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: ShoeAIColors.laceGray.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: ShoeAIColors.laceGray.withValues(alpha: 0.3),
                ),
              ),
              child: Row(
                children: [
