...
// RevenueCat + helper premium for Custom Car AI (iOS + Android ready)
...
const tokenPack5Id = 'ai.custom_car.token5';
...
Future<bool> presentPaywallGuarded(BuildContext context) async {
  ...
  try {
    debugPrint('🟢 Opening Custom Car AI paywall...');
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => const HotelPaywall(),
      ),
    );
