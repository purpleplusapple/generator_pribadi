          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', HotelAIColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', HotelAIColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: HotelAIColors.leatherTan,
                              shape: BoxShape.circle,
                              boxShadow: HotelAIShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: HotelAIColors.canvasWhite,
                                width: 3,
                              ),
                ...
                child: Center(
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                      ...
                      vertical: HotelAISpacing.md,
                    ),
                    decoration: BoxDecoration(
                      color: HotelAIColors.soleBlack.withValues(alpha: 0.8),
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(
                        color: HotelAIColors.canvasWhite.withValues(alpha: 0.2),
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: HotelAISpacing.sm),
                        Text(
