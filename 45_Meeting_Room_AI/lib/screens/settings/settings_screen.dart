...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _clearHistory() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: MeetingAIColors.soleBlack,
        title: Text(
          'Clear All History?',
          style: MeetingAIText.h3,
        ),
        content: Text(
          'This will permanently delete all saved redesigns. This action cannot be undone.',
          style: MeetingAIText.body,
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: MeetingAIColors.error,
            ),
      ...
      body: _isLoading
          ? const Center(
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(MeetingAIColors.leatherTan),
              ),
            )
          : ListView(
              padding: const EdgeInsets.all(MeetingAISpacing.base),
              children: [
          ...
          Row(
            children: [
              Icon(
                ...
                color: _isPremium ? MeetingAIColors.laceGray : MeetingAIColors.leatherTan,
                size: 28,
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: MeetingAIText.h3.copyWith(fontSize: 18),
                    ),
                    ...
                    Text(
                      ...
                      style: MeetingAIText.caption.copyWith(
                        color: MeetingAIColors.canvasWhite.withValues(alpha: 0.7),
                      ),
                    ),
                  ],
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildActionRow(
            ...
            label: 'Clear History',
            onTap: _clearHistory,
            iconColor: MeetingAIColors.error,
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(
            ...
            label: 'Support',
            value: 'support@laundryroomai.com',
          ),

          const SizedBox(height: MeetingAISpacing.md),

          Text(
            '© 2026 Meeting Room AI\nTransform your space with AI',
            style: MeetingAIText.caption.copyWith(
              color: MeetingAIColors.canvasWhite.withValues(alpha: 0.5),
            ),
  ...
  Widget _buildActionRow({
    ...
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: MeetingAISpacing.sm),
        child: Row(
          children: [
            Icon(
              icon,
              color: iconColor ?? MeetingAIColors.leatherTan,
              size: 24,
            ),
            const SizedBox(width: MeetingAISpacing.md),
            Expanded(
              child: Text(
                label,
                style: MeetingAIText.bodyMedium,
              ),
            ),
            Icon(
          ...
          Row(
            children: [
              Icon(
                ...
                color: _developerMode ? MeetingAIColors.laceGray : MeetingAIColors.canvasWhite.withValues(alpha: 0.7),
                size: 24,
              ),
              const SizedBox(width: MeetingAISpacing.md),
              Expanded(
              ...
              Switch(
                ...
                activeTrackColor: MeetingAIColors.leatherTan,
              ),
            ],
          ),
          ...
          if (_developerMode) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: MeetingAIColors.laceGray.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: MeetingAIColors.laceGray.withValues(alpha: 0.3),
                ),
              ),
              child: Row(
                children: [
                  Icon(
                    ...
                    color: MeetingAIColors.laceGray,
                    size: 20,
                  ),
