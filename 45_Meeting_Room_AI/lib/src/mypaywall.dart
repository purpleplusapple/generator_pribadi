...
// Meeting Room AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:meeting_room_ai/src/credits_vault.dart';
import 'package:meeting_room_ai/src/app_assets.dart';
import 'package:meeting_room_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
...
const _bgBase = MeetingAIColors.pitBlack;
...
const _textPrimary = MeetingAIColors.textMain;
const _textSecondary = MeetingAIColors.textMuted;
...
class _CustomCarPaywallState extends State<CustomCarPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Meeting Room AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Meeting Room AI tokens added.");
    } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Meeting Room AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Meeting Room AI ===========================
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    ...
    default:
      return "Unlock full Meeting Room AI experience.";
  }
}
