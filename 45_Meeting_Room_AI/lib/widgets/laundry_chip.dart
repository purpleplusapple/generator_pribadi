        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: widget.isSelected
                ? MeetingAIColors.leatherTan.withValues(alpha: 0.15)
                : MeetingAIColors.canvasWhite.withValues(alpha: 0.05),
            borderRadius: MeetingAIRadii.chipRadius,
            border: Border.all(
              color: widget.isSelected
                  ? MeetingAIColors.leatherTan
                  : MeetingAIColors.canvasWhite.withValues(alpha: 0.2),
              width: 1.5,
            ),
          ),
          child: Row(
            ...
            children: [
              if (widget.icon != null) ...[
                ...
                const SizedBox(width: MeetingAISpacing.xs),
              ],
              Text(
                widget.label,
