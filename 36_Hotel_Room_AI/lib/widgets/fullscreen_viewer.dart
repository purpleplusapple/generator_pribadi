  ...
  Future<void> _shareImage(BuildContext context) async {
    try {
      await Share.shareXFiles(
        [XFile(imagePath)],
        text: 'Check out my AI-generated hotel room redesign!',
      );
    } catch (e) {
      if (context.mounted) {
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: HotelAIColors.soleBlack,
        title: Text(
          'Delete This Result?',
        ...
        actions: [
          ...
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: HotelAIColors.error,
            ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color: color ?? HotelAIColors.leatherTan,
              size: 28,
            ),
