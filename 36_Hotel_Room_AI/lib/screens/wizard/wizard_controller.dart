...
class WizardController extends ChangeNotifier {
  int _currentStep = 0;
  HotelAIConfig _config = HotelAIConfig.empty();
  ...
  HotelAIConfig get config => _config;
  ...
  String? getValidationMessage(int step) {
    ...
    switch (step) {
      case 0:
        return 'Please upload a hotel room photo to continue';
      case 1:
