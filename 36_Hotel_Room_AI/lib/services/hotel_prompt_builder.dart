// lib/services/hotel_prompt_builder.dart
// AI prompt generation from user selections

import '../model/hotel_ai_config.dart';

class HotelPromptBuilder {
  /// Build a prompt from HotelAIConfig
  String buildPrompt(HotelAIConfig config) {
    final StringBuffer prompt = StringBuffer();

    // Base instruction
    prompt.writeln(
      'A professional interior design photo of a modern hotel room with the following specifications:',
    );
    prompt.writeln();
