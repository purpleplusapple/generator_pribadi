  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Welcome to Rooftop Lounge AI Premium!")));
      }
    } catch (e) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const Text("Rooftop Lounge AI Premium", style: TextStyle(color: DesignTokens.ink0, fontSize: 24, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
