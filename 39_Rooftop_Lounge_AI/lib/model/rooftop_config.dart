...
class RooftopConfig {
  ...
  factory RooftopConfig.fromJson(Map<String, dynamic> json) {
    return RooftopConfig(
  ...
  RooftopConfig addStyleSelection(String category, String value) {
  ...
  RooftopConfig removeStyleSelection(String category) {
    final newSelections = Map<String, String>.from(styleSelections);
  ...
  @override
  String toString() {
    return 'RooftopConfig(originalImage: $originalImagePath, '
