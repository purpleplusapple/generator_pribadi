...
class DatabaseService {
  ...
  static const String _dbName = 'terrace_room.db';
  ...
  Future<void> migrateFromPrefs() async {
    ...
    const String historyKey = 'terrace_history_ids';
    ...
    for (final id in historyIds) {
      await prefs.remove('terrace_result_$id');
    }
