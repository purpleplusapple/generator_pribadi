...
// Balcony Terrace AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:balcony_terrace_ai/src/credits_vault.dart';
import 'package:balcony_terrace_ai/src/app_assets.dart';
import 'package:balcony_terrace_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
...
const _bgBase = TerraceAIColors.pitBlack;
...
const _textPrimary = TerraceAIColors.textMain;
const _textSecondary = TerraceAIColors.textMuted;
...
class _CustomCarPaywallState extends State<CustomCarPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Balcony Terrace AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Balcony Terrace AI tokens added.");
    } catch (e) {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TweenAnimationBuilder<double>(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "10 daily redesigns, priority rendering, and all style options for your perfect terrace space.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
            ...
            ValueListenableBuilder<bool>(
              ...
              builder: (context, isPro, _) {
                ...
                final subtitle = isPro
                    ...
                    : "Upgrade to Premium to unlock AI terrace room generation and all premium features.";
                return Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(
                    horizontal: 12,
            ...
            _feature(
              "10 AI terrace room redesigns per day with premium quality.",
            ),
            _feature(
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Balcony Terrace AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Balcony Terrace AI ===========================
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    ...
    default:
      return "Unlock full Balcony Terrace AI experience.";
  }
}
