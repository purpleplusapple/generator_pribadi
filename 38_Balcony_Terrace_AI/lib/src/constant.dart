...
// RevenueCat + helper premium for Balcony Terrace AI (iOS + Android ready)
...
const entitlementKey = 'terracemods';
const int kPremiumDailyLimit = 10;

const tokenPack5Id = 'ai.balcony_terrace.token5';
...
const _kPremiumDailyKeyPrefix = 'terrace_premium_daily_';
...
Future<bool> presentPaywallGuarded(BuildContext context) async {
  ...
  try {
    debugPrint('🟢 Opening Balcony Terrace AI paywall...');
