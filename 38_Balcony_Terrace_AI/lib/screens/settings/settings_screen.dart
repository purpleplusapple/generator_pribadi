...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _clearHistory() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: TerraceColors.soleBlack,
        title: Text(
          'Clear All History?',
        ...
        actions: [
          ...
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: TerraceColors.error,
            ),
      ...
      body: _isLoading
          ? const Center(
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(TerraceColors.leatherTan),
              ),
            )
          : ListView(
          ...
          Row(
            children: [
              Icon(
                ...
                color: _isPremium ? TerraceColors.laceGray : TerraceColors.leatherTan,
                size: 28,
              ),
  ...
  Widget _buildActionRow({
    ...
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: TerraceSpacing.sm),
        child: Row(
          children: [
            Icon(
              icon,
              color: iconColor ?? TerraceColors.leatherTan,
              size: 24,
            ),
            const SizedBox(width: TerraceSpacing.md),
            Expanded(
          ...
          Row(
            children: [
              Icon(
                ...
                color: _developerMode ? TerraceColors.laceGray : TerraceColors.canvasWhite.withValues(alpha: 0.7),
                size: 24,
              ),
              const SizedBox(width: TerraceSpacing.md),
              Expanded(
                    ...
                    Text(
                      ...
                      style: TerraceText.caption.copyWith(
                        color: _developerMode
                            ? TerraceColors.metallicGold
                            : TerraceColors.canvasWhite.withValues(alpha: 0.6),
                      ),
                    ),
                  ],
                ),
              ...
              Switch(
                ...
                activeTrackColor: TerraceColors.leatherTan,
              ),
            ],
          ),
