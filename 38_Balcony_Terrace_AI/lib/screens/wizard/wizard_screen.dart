...
import 'steps/style_terrace_step.dart';
...
class _WizardScreenState extends State<WizardScreen> {
  ...
  List<Widget> get _steps => [
    ...
    StyleTerraceStep(controller: _controller),
    ...
    return Padding(
      ...
      child: GlassCard(
        padding: const EdgeInsets.symmetric(
          horizontal: TerraceSpacing.lg,
          vertical: TerraceSpacing.md,
        ),
        child: Row(
  ...
  Widget _buildStepCircle(int index) {
    ...
    if (isCompleted) {
      ...
      color = TerraceColors.canvasWhite.withValues(alpha: 0.2);
      child = Text(
        '${index + 1}',
        style: TerraceText.caption.copyWith(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isCurrent
                ? Border.all(
                    color: TerraceColors.leatherTan.withValues(alpha: 0.3),
                    width: 3,
                  )
                : null,
          ),
          ...
          style: TerraceText.small.copyWith(
            color: isCurrent
                ...
                : isCompleted
                    ...
                    : TerraceColors.canvasWhite.withValues(alpha: 0.5),
  ...
  Widget _buildValidationMessage() {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(
        horizontal: TerraceSpacing.base,
