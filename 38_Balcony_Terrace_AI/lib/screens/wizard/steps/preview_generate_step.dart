...
class _PreviewGenerateStepState extends State<PreviewGenerateStep> {
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Subtitle
                  Text(
                    'Your AI-powered terrace room transformation is ready',
                  ...
                  if (hasImage) const SizedBox(height: TerraceAISpacing.lg),

                  // Style Selections Card (Redesigned with chips)
                  if (selectionsCount > 0) _buildStyleSelectionsCard(),

                  if (selectionsCount > 0) const SizedBox(height: TerraceAISpacing.md),
                  ...
                  if (hasNotes) const SizedBox(height: TerraceAISpacing.md),
                  ...
                  Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(TerraceAIRadii.button),
                      boxShadow: TerraceAIShadows.goldGlow(opacity: 0.3),
                    ),
    ...
    return GlassCard(
      ...
      child: Stack(
        children: [
          ...
          // Top overlay badge
          Positioned(
            top: TerraceAISpacing.md,
            right: TerraceAISpacing.md,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(TerraceAIRadii.chip),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Style Selections',
                style: TerraceAIText.h3.copyWith(fontSize: 16),
              ),
            ],
          ),
          ...
          Wrap(
            spacing: TerraceAISpacing.sm,
            runSpacing: TerraceAISpacing.sm,
            children: selections.entries.map((entry) {
              return Container(
                ...
                decoration: BoxDecoration(
                  color: TerraceAIColors.metallicGold.withValues(alpha: 0.15),
                  border: Border.all(
                    color: TerraceAIColors.metallicGold.withValues(alpha: 0.3),
                  ),
                  borderRadius: BorderRadius.circular(TerraceAIRadii.chip),
                ),
                child: Row(
  ...
  Widget _buildConfigItem({
    ...
    final color = isComplete
        ? TerraceAIColors.success
        : isOptional
            ? TerraceAIColors.canvasWhite.withValues(alpha: 0.4)
            : TerraceAIColors.warning;

    return Container(
      padding: const EdgeInsets.all(TerraceAISpacing.md),
      decoration: BoxDecoration(
        color: TerraceAIColors.canvasWhite.withValues(alpha: 0.03),
        borderRadius: BorderRadius.circular(TerraceAISpacing.md),
        border: Border.all(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(TerraceAISpacing.md),
            decoration: BoxDecoration(
              color: TerraceAIColors.leatherTan.withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(TerraceAISpacing.md),
              border: Border.all(
                color: TerraceAIColors.leatherTan.withValues(alpha: 0.2),
              ),
            ),
            child: Text(
              notes,
