...
class TerraceAIConfig {
  ...
  TerraceAIConfig addStyleSelection(String category, String value) {
  ...
  TerraceAIConfig removeStyleSelection(String category) {
    final newSelections = Map<String, String>.from(styleSelections);
  ...
  bool operator ==(Object other) {
    ...
    return other is TerraceAIConfig &&
  ...
  @override
  String toString() {
    return 'TerraceAIConfig(originalImage: $originalImagePath, '
