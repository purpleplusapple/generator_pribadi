...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  // ================== QUESTIONS (Balcony Terrace AI) ==================

  final List<_Question> _questions = [
    _Question(
      keyName: 'q_experience',
      title: 'What describes your terrace situation?',
    ...
    _Question(
      ...
      options: [
        'Create an efficient home terrace room',
        'Design a multi-purpose closet space',
        'Maximize storage and organization',
        'Visualize a premium terrace area',
      ],
    ),
    _Question(
      keyName: 'q_category',
    ...
    _Question(
      keyName: 'q_flow',
      title: 'How do you plan to use Balcony Terrace AI?',
  ...
  Future<void> _finish() async {
    ...
    final steps = [
      'Understanding your terrace goals…',
  ...
  Widget build(BuildContext context) {
    ...
    const secondary = TerraceAIColors.metallicGold;
    const accentSoft = TerraceAIColors.laceGray;
  ...
  String _finalStepText() {
    const steps = [
      'Locking in your terrace preferences…',
      'Securing your Balcony Terrace AI workspace…',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text(
                "Upload a photo and let AI create a clean, organized terrace space with previews you can save and share.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.white70,
                  height: 1.35,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "What should we call you inside Balcony Terrace AI?",
                textAlign: TextAlign.center,
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [
            TerraceAIColors.leatherTan, // aqua
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? TerraceAIColors.leatherTan : Colors.white70;
