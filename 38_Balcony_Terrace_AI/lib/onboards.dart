...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Widget build(BuildContext context) {
    ...
    const primary = TerraceColors.leatherTan;
    const secondary = TerraceColors.metallicGold;
    const accentSoft = TerraceColors.laceGray;
    const bg = TerraceColors.soleBlack;
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? TerraceColors.leatherTan : Colors.white70;
