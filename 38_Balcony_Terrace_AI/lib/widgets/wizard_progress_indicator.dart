        ...
        children: [
          ...
          Row(
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: TerraceColors.canvasWhite.withValues(alpha: 0.1),
              ...
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: TerraceSpacing.sm,
                  vertical: 4,
                ),
                decoration: BoxDecoration(
                  gradient: TerraceGradients.accentHighlight,
  ...
  Widget _buildStepCircle(int stepNumber, String label, {
    ...
    return Column(
      children: [
        ...
        AnimatedContainer(
          duration: TerraceMotion.standard,
          curve: TerraceMotion.emphasizedEasing,
          ...
          decoration: BoxDecoration(
            ...
            color: isCompleted || isCurrent
                ? null
                : TerraceColors.canvasWhite.withValues(alpha: 0.15),
            ...
            boxShadow: isCurrent
                ? TerraceShadows.goldGlow(opacity: 0.6)
                : null,
          ),
          child: Center(
            child: isCompleted
