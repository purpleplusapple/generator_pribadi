...
class _GradientButtonState extends State<GradientButton>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      begin: 1.0,
      end: TerraceAIMotion.buttonPressScale,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: isDisabled
                ? LinearGradient(
                    colors: [
                      TerraceAIColors.laceGray.withValues(alpha: 0.3),
                      TerraceAIColors.laceGray.withValues(alpha: 0.3),
                    ],
                  )
                : TerraceAIGradients.primaryCta,
            borderRadius: TerraceAIRadii.buttonRadius,
            border: Border.all(
              color: isDisabled
                  ? Colors.transparent
                  : TerraceAIColors.metallicGold.withValues(alpha: 0.3),
              width: 1.5,
            ),
            boxShadow: isDisabled
                ...
                : [
                    // Primary shadow
                    BoxShadow(
                      color: TerraceAIColors.leatherTan.withValues(alpha: 0.4),
                      blurRadius: 20,
                      offset: const Offset(0, 6),
                    ),
                    // Secondary glow
                    BoxShadow(
                      color: TerraceAIColors.metallicGold.withValues(alpha: 0.25),
                      blurRadius: 12,
                ...
                : Row(
                    ...
                    children: [
                      if (widget.icon != null) ...[
                        ...
                        const SizedBox(width: TerraceAISpacing.md), // Increased spacing
                      ],
                      Text(
                        widget.label,
                        style: TerraceAIText.button.copyWith(
                          color: TerraceAIColors.soleBlack,
