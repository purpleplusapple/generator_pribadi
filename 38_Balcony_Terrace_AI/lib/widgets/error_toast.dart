...
class ErrorToast {
  ...
  static void show(BuildContext context, String message) {
    _showToast(
      ...
      borderColor: TerraceAIColors.error,
    );
  }
  ...
  static void showSuccess(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: TerraceAIColors.success,
      borderColor: TerraceAIColors.success,
    );
  }
  ...
  static void showInfo(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: TerraceAIColors.leatherTan,
      borderColor: TerraceAIColors.leatherTan,
    );
  }
...
class _ToastWidgetState extends State<_ToastWidget>
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: MediaQuery.of(context).padding.top + TerraceAISpacing.base,
