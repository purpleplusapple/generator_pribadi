          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', TerraceColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', TerraceColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: TerraceShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: TerraceColors.canvasWhite,
                                width: 3,
                              ),
              ...
              Positioned(
                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: TerraceColors.soleBlack.withValues(alpha: 0.8),
