...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  // ================== QUESTIONS (Storage Utility Room AI) ==================

  final List<_Question> _questions = [
    _Question(
      keyName: 'q_experience',
      title: 'What describes your storage needs?',
      subtitle: 'We tailor the systems to your workflow.',
      options: [
        'Homeowner – full reorganization',
        'Renter – damage-free systems',
        'Pro Organizer – planning for client',
        'Contractor – utility build-out',
      ],
    ),
    _Question(
      keyName: 'q_goal',
      title: 'What is your main goal?',
      subtitle: 'This helps us prioritize the zoning.',
      options: [
        'Maximize vertical storage',
        'Create a dedicated laundry zone',
        'Organize tools and hardware',
        'Hide clutter behind cabinets',
      ],
    ),
    _Question(
      keyName: 'q_category',
    ...
    _Question(
      keyName: 'q_style',
      title: 'Which aesthetic fits your space?',
      subtitle: 'We will use this as your baseline.',
      options: [
        'Pro Industrial (Pegboard, Metal)',
        'Clean White Utility (Hidden)',
        'Warm Wood (Scandinavian)',
        'Heavy Duty Workshop',
        'Modern Matte Black',
      ],
    ),
    _Question(
      ...
      subtitle: 'We suggest systems that fit your range.',
      options: [
        'DIY / Budget Friendly',
        'Mid-Range (IKEA/Container Store)',
        'Pro / Custom Cabinetry',
        'Luxury Workshop',
      ],
    ),
    _Question(
      keyName: 'q_flow',
      title: 'How do you plan to use Storage Utility AI?',
  ...
  Future<void> _finish() async {
    ...
    final steps = [
      'Understanding your storage goals…',
      'Optimizing vertical space…',
      'Preparing your utility workspace…',
    ];
  ...
  Widget build(BuildContext context) {
    ...
    const primary = StorageColors.primaryLime;
    const secondary = StorageColors.accentAmber;
    const accentSoft = StorageColors.muted;
    const bg = StorageColors.bg0;
  ...
  String _finalStepText() {
    const steps = [
      'Locking in your storage preferences…',
      'Securing your Storage Utility AI workspace…',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text(
                "Upload a photo and let AI create a pro-grade organized utility space with previews you can save and share.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.white70,
                  height: 1.35,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "What should we call you inside Storage Utility AI?",
                textAlign: TextAlign.center,
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [
            StorageColors.primaryLime, // aqua
            StorageColors.bg0,
          ],
        ),
      ),
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? StorageColors.primarySoft : Colors.white70;
