...
class _SplashScreenState extends State<SplashScreen> {
  String _loadingText = "Preparing Small Apartment Studio AI...";
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text("Small Apartment Studio AI", style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontFamily: 'DM Serif Display', color: DesignTokens.ink0)),
