// lib/model/apartment_config.dart
...
class ApartmentConfig {
  ...
  factory ApartmentConfig.fromJson(Map<String, dynamic> json) {
    return ApartmentConfig(
  ...
  ApartmentConfig addStyleSelection(String category, String value) {
  ...
  ApartmentConfig removeStyleSelection(String category) {
    final newSelections = Map<String, String>.from(styleSelections);
  ...
  bool operator ==(Object other) {
    ...
    return other is ApartmentConfig &&
  ...
  @override
  String toString() {
    return 'ApartmentConfig(originalImage: $originalImagePath, '
