        ...
        Positioned.fill(
          child: Container(
            decoration: const BoxDecoration(
              gradient: CamperAIGradients.background,
            ),
          ),
        ),
        // Animated blobs
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: RadialGradient(
                ...
                radius: 1.5,
                colors: [
                  CamperAIColors.leatherTan.withValues(alpha: 0.05),
                  Colors.transparent,
                ],
              ),
            ),
...
class _BubblePainter extends CustomPainter {
  ...
  static final _blobs = [
    _BlobConfig(
      color: CamperAIColors.leatherTan.withValues(alpha: 0.04),
      startX: 0.2,
      startY: 0.3,
      radius: 0.4,
      speedX: 0.15,
    ...
    _BlobConfig(
      color: CamperAIColors.metallicGold.withValues(alpha: 0.03),
      startX: 0.7,
      startY: 0.2,
      radius: 0.35,
      speedX: -0.12,
    ...
    _BlobConfig(
      color: CamperAIColors.laceGray.withValues(alpha: 0.02),
      startX: 0.5,
      startY: 0.7,
      radius: 0.3,
      speedX: 0.1,
    ...
    _BlobConfig(
      color: CamperAIColors.leatherTan.withValues(alpha: 0.03),
      startX: 0.1,
      startY: 0.8,
      radius: 0.25,
      speedX: 0.18,
