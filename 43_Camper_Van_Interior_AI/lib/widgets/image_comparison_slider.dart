          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', CamperAIColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', CamperAIColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: CamperAIShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: CamperAIColors.canvasWhite,
                                width: 3,
                              ),
                ...
                child: Center(
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                      horizontal: CamperAISpacing.lg,
                      vertical: CamperAISpacing.md,
                    ),
                    decoration: BoxDecoration(
                      color: CamperAIColors.soleBlack.withValues(alpha: 0.8),
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(
                        color: CamperAIColors.canvasWhite.withValues(alpha: 0.2),
                      ),
                    ),
                    child: Row(
