...
class ErrorToast {
  ...
  static void show(BuildContext context, String message) {
    _showToast(
      ...
      borderColor: CamperAIColors.error,
    );
  }
  ...
  static void showSuccess(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: CamperAIColors.success,
      borderColor: CamperAIColors.success,
    );
  }
  ...
  static void showInfo(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: CamperAIColors.leatherTan,
      borderColor: CamperAIColors.leatherTan,
    );
  }
...
class _ToastWidgetState extends State<_ToastWidget>
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: MediaQuery.of(context).padding.top + CamperAISpacing.base,
      left: CamperAISpacing.base,
      right: CamperAISpacing.base,
