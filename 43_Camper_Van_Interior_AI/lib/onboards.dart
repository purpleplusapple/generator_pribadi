...
import 'package:camper_van_ai/theme/camper_theme.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  // ================== QUESTIONS (Camper Van AI) ==================

  final List<_Question> _questions = [
    _Question(
      keyName: 'q_experience',
      title: 'What describes your van plan?',
      subtitle: 'We tailor the guide to your phase.',
      options: [
        'Just Dreaming – looking for ideas',
        'Buying Soon – researching options',
        'Building Now – need layouts',
        'Van Owner – renovating existing',
      ],
    ),
    _Question(
      keyName: 'q_goal',
      title: 'What is the main purpose?',
      subtitle: 'This defines the layout priorities.',
      options: [
        'Full-time Van Life',
        'Weekend Adventures',
        'Mobile Office / Work',
    ...
    _Question(
      ...
      subtitle: 'Dimensions matter for the AI.',
      options: [
        'Sprinter / High Roof Van',
        'Ford Transit / Promaster',
        'Low Roof / Minivan',
        'Box Truck / Skoolie',
        'Other / SUV',
      ],
    ...
    _Question(
      keyName: 'q_style',
      title: 'Which aesthetic fits you?',
      subtitle: 'We will use this as a baseline.',
      options: [
        'Scandi Minimal (Light wood, white)',
        'Rugged Off-Road (Utility, dark)',
        'Cozy Cabin (Warm wood, rustic)',
        'Modern Tech (Clean, LED, sleek)',
      ],
    ),
    _Question(
      keyName: 'q_budget',
      title: 'What is your build budget?',
  ...
  Future<void> _finish() async {
    ...
    final steps = [
      'Calibrating for van dimensions…',
      'Loading conversion modules…',
      'Preparing your Van Studio…',
    ];
  ...
  Widget build(BuildContext context) {
    ...
    const primary = CamperAIColors.leatherTan;
    const secondary = CamperAIColors.metallicGold;
    const accentSoft = CamperAIColors.laceGray;
    const bg = CamperAIColors.soleBlack;
  ...
  String _randomLoadingText() {
    const msgs = [
      ...
      'Scanning layout options…',
      'Preparing design modules…',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text(
                "Design your dream van conversion with AI-powered layouts and premium visualizations.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.white70,
                  height: 1.35,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "What should we call you inside the studio?",
                textAlign: TextAlign.center,
...
class _TipTickerState extends State<_TipTicker> {
  static const tips = [
    ...
    'Tip: Use natural light to capture the true feel of the van.',
    'Tip: Capture the entire wall or space you want to convert.',
    'Tip: Think about where you want to place your kitchen unit.',
  ];
  int i = 0;
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [
            CamperAIColors.leatherTan, // aqua
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? CamperAIColors.leatherTan : Colors.white70;
