...
class WizardController extends ChangeNotifier {
  int _currentStep = 0;
  CamperConfig _config = CamperConfig.empty();
  ...
  bool canProceedFromStep(int step) {
    switch (step) {
      ...
      case 1: // Style
        return _config.hasStyleSelected;
  ...
  String? getValidationMessage(int step) {
    ...
    switch (step) {
      case 0:
        return 'Please upload a van photo to continue';
      case 1:
        return 'Please select a design style';
      default:
  ...
  void updateStyleParam(String key, dynamic value) {
    _config = _config.updateStyleParam(key, value);
    notifyListeners();
  }

  void setStyleParams(Map<String, dynamic> params) {
    _config = _config.copyWith(styleParams: params);
    notifyListeners();
  }
