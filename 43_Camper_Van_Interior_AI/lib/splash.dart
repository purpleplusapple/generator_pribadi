// Camper Van AI splash → routes to onboarding once, then RootShell
import 'dart:async';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  String _loadingText = "Preparing your Van Studio…";
  ...
  void _cycleLoadingText() {
    const variants = [
      ...
      "Loading solar configurations…",
      "Polishing wood textures…",
      "Optimizing storage hacks…",
      "Preparing road-luxe assets…",
    ];
    int i = 0;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Transform.translate(
                          ...
                          child: const Text(
                            "Design your dream van conversion with AI.",
            ...
            child: Opacity(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    "Your van photos stay private and are only used to generate conversion ideas.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
