...
// Camper Van Interior AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:camper_van_interior_ai/src/credits_vault.dart';
import 'package:camper_van_interior_ai/src/app_assets.dart';
import 'package:camper_van_interior_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
        entitlementKey,
        kToken5ProductId;
import 'package:camper_van_interior_ai/theme/shoe_room_ai_theme.dart';
...
class _CustomCarPaywallState extends State<CustomCarPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Camper Van Interior AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Camper Van Interior AI tokens added.");
    } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            TweenAnimationBuilder<double>(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Camper Van Interior AI Premium",
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Camper Van Interior AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Camper Van Interior AI ===========================
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    ...
    default:
      return "Unlock full Camper Van Interior AI experience.";
  }
}
