...
// Camper Van AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:camper_van_ai/src/credits_vault.dart';
import 'package:camper_van_ai/src/app_assets.dart';
import 'package:camper_van_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
        entitlementKey,
        kToken5ProductId;
import 'package:camper_van_ai/theme/camper_van_ai_theme.dart';
import 'package:purchases_flutter/purchases_flutter.dart';
import 'package:url_launcher/url_launcher.dart';

const _bgBase = CamperAIColors.pitBlack;
...
const _textPrimary = CamperAIColors.textMain;
const _textSecondary = CamperAIColors.textMuted;
...
class _CustomCarPaywallState extends State<CustomCarPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Camper Van AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Camper Van AI tokens added.");
    } catch (e) {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _feature(
              "No ads; pro-level experience for enthusiasts planning their dream van builds.",
            ),
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Camper Van AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Camper Van AI ===========================
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    ...
    default:
      return "Unlock full Camper Van AI experience.";
  }
}
