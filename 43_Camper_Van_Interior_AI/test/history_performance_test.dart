...
import 'package:camper_van_ai/services/laundry_history_repository.dart';
import 'package:camper_van_ai/services/shoe_result_storage.dart';
import 'package:camper_van_ai/model/shoe_ai_config.dart';
...
void main() {
  test('Performance benchmark for LaundryHistoryRepository', () async {
    ...
    // Create dummy config
    final config = CamperAIConfig.empty();
