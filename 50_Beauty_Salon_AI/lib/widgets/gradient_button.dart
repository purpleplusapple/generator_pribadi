...
class _GradientButtonState extends State<GradientButton>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      begin: 1.0,
      end: BeautyAIMotion.buttonPressScale,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: isDisabled
                ? LinearGradient(
                    colors: [
                      BeautyAIColors.sageGreen.withValues(alpha: 0.3),
                      BeautyAIColors.sageGreen.withValues(alpha: 0.3),
                    ],
                  )
            ...
            border: Border.all(
              color: isDisabled
                  ? Colors.transparent
                  : BeautyAIColors.metallicGold.withValues(alpha: 0.3),
              width: 1.5,
            ),
            boxShadow: isDisabled
                ...
                : [
                    // Primary shadow
                    BoxShadow(
                      color: BeautyAIColors.roseGold.withValues(alpha: 0.4),
                      blurRadius: 20,
                      offset: const Offset(0, 6),
                    ),
                    // Secondary glow
                    BoxShadow(
                      color: BeautyAIColors.metallicGold.withValues(alpha: 0.25),
                      blurRadius: 12,
                ...
                : Row(
                    ...
                    children: [
                      if (widget.icon != null) ...[
                        ...
                        const SizedBox(width: BeautyAISpacing.md), // Increased spacing
                      ],
                      Text(
                        widget.label,
