          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', BeautyAIColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', BeautyAIColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: BeautyAIShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: BeautyAIColors.creamWhite,
                                width: 3,
                              ),
