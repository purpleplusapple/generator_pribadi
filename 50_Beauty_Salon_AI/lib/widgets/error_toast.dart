...
class ErrorToast {
  ...
  static void show(BuildContext context, String message) {
    _showToast(
      ...
      borderColor: BeautyAIColors.error,
    );
  }
  ...
  static void showSuccess(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: BeautyAIColors.success,
      borderColor: BeautyAIColors.success,
    );
  }
  ...
  static void showInfo(BuildContext context, String message) {
    _showToast(
      ...
      iconColor: BeautyAIColors.roseGold,
      borderColor: BeautyAIColors.roseGold,
    );
  }
...
class _ToastWidgetState extends State<_ToastWidget>
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: MediaQuery.of(context).padding.top + BeautyAISpacing.base,
      left: BeautyAISpacing.base,
      right: BeautyAISpacing.base,
