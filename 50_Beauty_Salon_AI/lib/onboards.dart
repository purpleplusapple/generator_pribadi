...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  // ================== QUESTIONS (Beauty Salon AI) ==================

  final List<_Question> _questions = [
    _Question(
      keyName: 'q_experience',
      title: 'What describes your salon vision?',
      subtitle: 'We tailor the space to your needs.',
      options: [
        'Salon Owner – planning a remodel',
        'New Owner – looking for inspiration',
        'Interior Designer – creating for clients',
        'Contractor – building salon spaces',
      ],
    ),
    _Question(
      keyName: 'q_goal',
      ...
      options: [
        'Create an efficient salon layout',
        'Design a welcoming reception area',
        'Maximize workstation capacity',
        'Visualize a luxury spa experience',
      ],
    ),
    _Question(
      keyName: 'q_category',
    ...
    _Question(
      ...
      options: [
        'Modern Luxury (rose gold, marble)',
        'Minimalist Zen (earth tones, wood)',
        'Industrial Chic (black, concrete)',
        'Boho Glam (plants, warm lights)',
        'Classic Elegant (white, cream, silver)',
      ],
    ),
    _Question(
      keyName: 'q_budget',
    ...
    _Question(
      keyName: 'q_flow',
      title: 'How do you plan to use Beauty Salon AI?',
  ...
  Future<void> _finish() async {
    ...
    final steps = [
      'Understanding your salon goals…',
      'Optimizing client flow & layout…',
      'Preparing your sleek design workspace…',
    ];
  ...
  String _finalStepText() {
    const steps = [
      'Locking in your style preferences…',
      'Securing your Beauty Salon AI workspace…',
