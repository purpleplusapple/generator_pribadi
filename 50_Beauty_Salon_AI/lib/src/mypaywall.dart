...
// Beauty Salon AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:beauty_salon_ai/src/credits_vault.dart';
import 'package:beauty_salon_ai/src/app_assets.dart';
import 'package:beauty_salon_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
...
class BeautySalonPaywall extends StatefulWidget {
  ...
  @override
  State<BeautySalonPaywall> createState() => _BeautySalonPaywallState();
}

class _BeautySalonPaywallState extends State<BeautySalonPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Beauty Salon AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Beauty Salon AI tokens added.");
    } catch (e) {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TweenAnimationBuilder<double>(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "10 daily redesigns, priority rendering, and all style options for your perfect salon space.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
            ...
            ValueListenableBuilder<bool>(
              ...
              builder: (context, isPro, _) {
                ...
                final subtitle = isPro
                    ...
                    : "Upgrade to Premium to unlock AI salon generation and all premium features.";
                return Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(
                    horizontal: 12,
            ...
            _feature(
              "10 AI salon redesigns per day with premium quality.",
            ),
            _feature(
              "Unlimited generations with token packs when you need more.",
            ),
            _feature(
              "Access every salon style, furniture kit, finishes, and layout preset.",
            ),
            _feature(
              "Priority queue for faster salon designs on busy days.",
            ),
            _feature(
              "Full history access with high-res downloads of your designs.",
            ),
            _feature(
              "No ads; pro-level experience for owners planning their dream salon.",
            ),
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Beauty Salon AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Beauty Salon AI ===========================
...
Widget _timeline() {
  final items = <_Milestone>[
    const _Milestone(
      title: "Right now",
      desc:
          "Unlock premium salon renders, priority generation, and full history instantly.",
    ...
    const _Milestone(
      title: "Month 1",
      desc:
          "Plan complete custom designs with confidence and creative freedom.",
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    case PackageType.weekly:
      return "Short-term access for quick design experiments or event weeks.";
    case PackageType.monthly:
