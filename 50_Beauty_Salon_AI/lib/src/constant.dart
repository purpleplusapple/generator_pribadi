...
// RevenueCat + helper premium for Beauty Salon AI (iOS + Android ready)
...
const entitlementKey = 'carmods';
const int kPremiumDailyLimit = 10;

const tokenPack5Id = 'ai.beauty_salon.token5';
...
const _kPremiumDailyKeyPrefix = 'beauty_salon_premium_daily_';
...
Future<bool> presentPaywallGuarded(BuildContext context) async {
  ...
  try {
    debugPrint('🟢 Opening Beauty Salon AI paywall...');
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => const BeautySalonPaywall(),
      ),
    );
