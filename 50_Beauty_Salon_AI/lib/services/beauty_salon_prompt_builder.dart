// lib/services/beauty_salon_prompt_builder.dart
// AI prompt generation from user selections

import '../model/beauty_salon_ai_config.dart';

class BeautySalonPromptBuilder {
  /// Build a prompt from BeautySalonAIConfig
  String buildPrompt(BeautySalonAIConfig config) {
    final StringBuffer prompt = StringBuffer();

    // Base instruction
    prompt.writeln(
      'A professional interior design photo of a modern beauty salon with the following specifications:',
    );
    prompt.writeln();
