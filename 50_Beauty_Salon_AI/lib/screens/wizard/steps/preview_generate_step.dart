...
import '../../../services/beauty_salon_prompt_builder.dart';
...
class _PreviewGenerateStepState extends State<PreviewGenerateStep> {
  ...
  final BeautySalonPromptBuilder _promptBuilder = BeautySalonPromptBuilder();
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Subtitle
                  Text(
                    'Your AI-powered salon transformation is ready',
                  ...
                  if (hasImage) const SizedBox(height: BeautyAISpacing.lg),

                  // Style Selections Card (Redesigned with chips)
                  if (selectionsCount > 0) _buildStyleSelectionsCard(),

                  if (selectionsCount > 0) const SizedBox(height: BeautyAISpacing.md),
                  ...
                  if (hasNotes) const SizedBox(height: BeautyAISpacing.md),
                  ...
                  Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(BeautyAIRadii.button),
                      boxShadow: BeautyAIShadows.goldGlow(opacity: 0.3),
                    ),
                    child: GradientButton(
                      label: 'Transform My Salon',
    ...
    return GlassCard(
      ...
      child: Stack(
        children: [
          ...
          // Top overlay badge
          Positioned(
            top: BeautyAISpacing.md,
            right: BeautyAISpacing.md,
            child: Container(
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Style Selections',
                style: BeautyAIText.h3.copyWith(fontSize: 16),
              ),
            ],
          ),
          ...
          Wrap(
            spacing: BeautyAISpacing.sm,
            runSpacing: BeautyAISpacing.sm,
            children: selections.entries.map((entry) {
              return Container(
                ...
                decoration: BoxDecoration(
                  color: BeautyAIColors.metallicGold.withValues(alpha: 0.15),
                  border: Border.all(
                    color: BeautyAIColors.metallicGold.withValues(alpha: 0.3),
                  ),
                  borderRadius: BorderRadius.circular(BeautyAIRadii.chip),
                ),
                child: Row(
  ...
  Widget _buildConfigItem({
    ...
    final color = isComplete
        ? BeautyAIColors.success
        : isOptional
            ? BeautyAIColors.creamWhite.withValues(alpha: 0.4)
            : BeautyAIColors.warning;

    return Container(
      padding: const EdgeInsets.all(BeautyAISpacing.md),
      decoration: BoxDecoration(
        color: BeautyAIColors.creamWhite.withValues(alpha: 0.03),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(BeautyAISpacing.md),
            decoration: BoxDecoration(
              color: BeautyAIColors.roseGold.withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(BeautyAISpacing.md),
              border: Border.all(
                color: BeautyAIColors.roseGold.withValues(alpha: 0.2),
              ),
            ),
            child: Text(
              notes,
  ...
  IconData _getIconForCategory(String category) {
    switch (category.toLowerCase()) {
      ...
      case 'storage / cabinetry':
        return Icons.shelves;
      case 'workstation surface':
