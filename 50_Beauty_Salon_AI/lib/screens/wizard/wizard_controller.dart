...
class WizardController extends ChangeNotifier {
  int _currentStep = 0;
  BeautySalonAIConfig _config = BeautySalonAIConfig.empty();
  ...
  BeautySalonAIConfig get config => _config;
  ...
  String? getValidationMessage(int step) {
    ...
    switch (step) {
      case 0:
        return 'Please upload a salon photo to continue';
      case 1:
  ...
  void resetWizard() {
    _currentStep = 0;
    _config = BeautySalonAIConfig.empty();
    notifyListeners();
  }
