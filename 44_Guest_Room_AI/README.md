...
Guest Room AI helps users design and visualize their dream shoe closet or storage space. Upload a photo of your space and let AI transform it into a perfectly organized, stylish shoe room.
...
- **Theme**: Custom GuestAI design system with premium materials palette
...
```
lib/
├── theme/              # GuestAI design system (colors, typography, etc)
├── model/              # Data models
...
- `lib/theme/guest_room_ai_theme.dart` - Complete design system
...
This project is a rebranding/adaptation of Guest Room AI, customized for shoe room organization and display.
