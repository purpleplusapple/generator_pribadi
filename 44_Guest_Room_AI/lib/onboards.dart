...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_Question> _questions = [
    ...
    _Question(
      keyName: 'q_flow',
      title: 'How do you plan to use Guest Room AI?',
  ...
  Widget build(BuildContext context) {
    ...
    const primary = GuestAIColors.leatherTan;
    const secondary = GuestAIColors.metallicGold;
    const accentSoft = GuestAIColors.laceGray;
    const bg = GuestAIColors.soleBlack;
  ...
  String _finalStepText() {
    const steps = [
      ...
      'Securing your Guest Room AI workspace…',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "What should we call you inside Guest Room AI?",
                textAlign: TextAlign.center,
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [
            GuestAIColors.leatherTan, // aqua
            GuestAIColors.soleBlack,
          ],
        ),
      ),
    );
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = primary ? GuestAIColors.leatherTan : Colors.white70;
