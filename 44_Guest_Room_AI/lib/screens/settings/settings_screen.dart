...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          Row(
            children: [
              Icon(
                ...
                color: _isPremium ? GuestAIColors.laceGray : GuestAIColors.leatherTan,
                size: 28,
              ),
  ...
  Widget _buildActionRow({
    ...
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: GuestAISpacing.sm),
        child: Row(
          children: [
            Icon(
              icon,
              color: iconColor ?? GuestAIColors.leatherTan,
              size: 24,
            ),
            const SizedBox(width: GuestAISpacing.md),
            Expanded(
          ...
          Row(
            children: [
              Icon(
                ...
                color: _developerMode ? GuestAIColors.laceGray : GuestAIColors.canvasWhite.withValues(alpha: 0.7),
                size: 24,
              ),
              const SizedBox(width: GuestAISpacing.md),
              Expanded(
                    ...
                    Text(
                      ...
                      style: GuestAIText.caption.copyWith(
                        color: _developerMode
                            ...
                            : GuestAIColors.canvasWhite.withValues(alpha: 0.6),
                      ),
                    ),
                  ],
                ),
              ...
              Switch(
                ...
                activeTrackColor: GuestAIColors.leatherTan,
              ),
            ],
          ),
          ...
          if (_developerMode) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: GuestAIColors.laceGray.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: GuestAIColors.laceGray.withValues(alpha: 0.3),
                ),
              ),
              child: Row(
                children: [
