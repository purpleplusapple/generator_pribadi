          ...
          return Stack(
            ...
            children: [
              ...
              Positioned(
                left: 16,
                top: 16,
                child: _buildLabel('BEFORE', GuestAIColors.error),
              ),
              Positioned(
                right: 16,
                top: 16,
                child: _buildLabel('AFTER', GuestAIColors.success),
              ),
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: GuestAIShadows.tanGlow(opacity: 0.5),
                              border: Border.all(
                                color: GuestAIColors.canvasWhite,
                                width: 3,
                              ),
              ...
              Positioned(
                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: GuestAIColors.soleBlack.withValues(alpha: 0.8),
