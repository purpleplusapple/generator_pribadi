...
// Guest Room AI — Premium Paywall (RevenueCat)
// ============================
...
import 'package:guest_room_ai/src/credits_vault.dart';
import 'package:guest_room_ai/src/app_assets.dart';
import 'package:guest_room_ai/src/constant.dart'
    show
        markJustPurchased,
        checkPremiumFresh,
        premiumListenable,
        entitlementKey,
        kToken5ProductId;
import 'package:guest_room_ai/theme/guest_room_ai_theme.dart';
import 'package:purchases_flutter/purchases_flutter.dart';
import 'package:url_launcher/url_launcher.dart';

const _bgBase = GuestAIColors.pitBlack;
...
const _textPrimary = GuestAIColors.textMain;
const _textSecondary = GuestAIColors.textMuted;
...
class _CustomCarPaywallState extends State<CustomCarPaywall>
  ...
  Future<void> _buyPackage(Package pkg) async {
    ...
    try {
      ...
      if (isPro) {
        ...
        _safeSnack("You have unlocked Guest Room AI Premium.");
      } else {
  ...
  Future<void> _buyToken5() async {
    ...
    try {
      ...
      if (!mounted) return;
      _safeSnack("5 extra Guest Room AI tokens added.");
    } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            if (_token5 == null)
              ...
              _tokenCard(
                title: "5 Extra Guest Room AI Tokens",
                description:
...
// ===== Shared UI bits tuned for Guest Room AI ===========================
...
String _getPlanDescription(PackageType type) {
  switch (type) {
    ...
    default:
      return "Unlock full Guest Room AI experience.";
  }
}
