...
// RevenueCat + helper premium for Barbershop AI
...
const appId = 'barbershop_ai_app';

const entitlementKey = 'pro_barber';
const int kPremiumDailyLimit = 10;

const tokenPack5Id = 'ai.barbershop.token5';
...
const _kPremiumDailyKeyPrefix = 'barber_premium_daily_';
...
Future<bool> presentPaywallGuarded(BuildContext context) async {
  ...
  try {
    debugPrint('🟢 Opening Barbershop AI paywall...');
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => const BarberPaywall(),
      ),
    );
